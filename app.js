...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Alain Sardin')
.pauseFor(300)
.typeString('<strong>, etudiant admin Cloud</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60;"> scripting</span> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #EA39ff;"> Javascript</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: midnightblue;"> Linux</span> !')
.pauseFor(1000)
.deleteChars(7)
.typeString('<span style="color: #ff6910;"> Microsoft Azure</span> !')
.start()
